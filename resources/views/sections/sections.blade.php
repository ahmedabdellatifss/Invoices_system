                    ...
                    <table id="example" class="table key-buttons text-md-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale" data-id="{{ $sec->id }}" data-section_name="{{ $sec->section_name }}" data-description="{{ $sec->description }}" data-toggle="modal" href="#exampleModal2" title="تعديل"><i class="las la-pen"></i></a>

                                    <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale" data-id="{{ $sec->id }}" data-section_name="{{ $sec->section_name }}" data-toggle="modal" href="#modaldemo9" title="حذف"><i class="las la-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
